...
class TestWorkflowValidation:
    ...
    def test_build_execution_levels_parallel_branches(self) -> None:
        ...
        workflow = Workflow(
            name="parallel_workflow", tasks=[task1, task2, task3, task4]
        )
    ...
    def test_build_execution_levels_multiple_parallel_branches(self) -> None:
        ...
        job5 = Job(
            name="job5", command=["echo", "5"], environment=JobEnvironment(conda="env5")
        )
        job6 = Job(
            name="job6", command=["echo", "6"], environment=JobEnvironment(conda="env6")
        )
        job7 = Job(
            name="job7", command=["echo", "7"], environment=JobEnvironment(conda="env7")
        )
        ...
        workflow = Workflow(
            name="complex_parallel_workflow",
    ...
    def test_execute_workflow_parallel_execution(self, mock_monitor: Mock) -> None:
        ...
        result_jobs = [
            ...
            Job(
                name="job4",
                command=["echo", "4"],
                environment=JobEnvironment(conda="env4"),
                job_id=444,
            ),
        ]
